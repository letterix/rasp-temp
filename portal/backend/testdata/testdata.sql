...
insert into installations (serial_number, model) values ('666', 'plc');

insert into controllers (installation, name, ip) values ('666', 'plc_1', '192.168.0.1');

insert into tags (name, type, address, controller_ip, installation) values
    ('YEAR', 'int', 'MW0', '192.168.0.1', '666'),
    ('MONTH', 'int', 'MW1', '192.168.0.1', '666'),
    ('DAY', 'int', 'MW2', '192.168.0.1', '666'),
    ('HOUR', 'int', 'MW3', '192.168.0.1', '666'),
    ('MINUTE', 'int', 'MW4', '192.168.0.1', '666'),
    ('YEAR', 'int', 'MW0', '192.168.0.2', '666');